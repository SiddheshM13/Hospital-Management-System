...
class modify implements ActionListener
	{
		public void actionPerformed(ActionEvent ae)
		{
			...
			//st.executeUpdate("UPDATE PAT SET patientno="+num1+",name='"+name1+"',address='"+addr1+"',contact='"+contact1+"',history='"+hist1+"',dd='"+dd1+"',mm='"+mm1+"',yy='"+yy1+"',current='"+current1+"' WHERE patientno='"+num1+"';");
			}
		...
		if(rs.next())
			{
                ...
                JOptionPane.showMessageDialog(null, "pid not Found");}
