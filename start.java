...
class start extends JFrame implements ActionListener
{
	...
	start()
	{
		...
		bback=new JButton("LOGOUT" ,new ImageIcon("images/preview_Hover.png"));
		bback.setBounds(230,515,150,30);
		add(bback);
			...
			public void actionPerformed(ActionEvent ae)
				{
					...
					startBGMusic1 page1 = new startBGMusic1();
					try{
						page1.playMusic();
